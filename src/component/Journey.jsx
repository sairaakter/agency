...
import exsix from "../assets/exsix.png";
import expthre from "../assets/exthre.png";
import expto from "../assets/exto.png";
import jornstyle from "../style/Journey.module.css";
...
export default function Journey() {
  const cardData = [
    ...
    },
    {
      ...
      hpp: "Our team of seasoned professionals brings years of experience and expertise to the table.",
      project_card: jornstyle.bdrrightno,
      brkpont: "col-lg-4 col-md-6 startcon_ttls p-0",
      isbutton: true,
      expertis: expthre,
    },
    ...
    {
      htwo: "Seamless Integration",
      hpp: "Our team of seasoned professionals brings years of experience and expertise to the table.",
      project_card: `${jornstyle.bdrrightno} ${jornstyle.inmdrn}`,
      brkpont: "col-lg-4 col-md-6 startcon_ttls p-0",
      isbutton: true,
      expertis: exsix,
    },
